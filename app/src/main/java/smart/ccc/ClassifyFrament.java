...
*/
       ...
       int classyNum= getActivity().getIntent().getExtras().getInt("classyNum");
        ...
        final GetArticleByClassifyService getArticleByClassifyService=retrofit.create(GetArticleByClassifyService.class);

            getArticleByClassifyService.get("concreteClassify", String.valueOf(classyNum))
